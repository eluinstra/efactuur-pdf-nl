clear
echo "*********************************************************************************************************"
echo "* Transforming UBL 1.6.3 Genericode Schematron into XSLT "
echo "* - - - - - - - - - - - - - - - - - - - - - - - - - - - - "
...
echo "*    Since in older versioe than 1.7, there is no cva dir. We copied the one for 1.7,  "
echo "*    because it includes the almost all of the same files, and thus can be reused."
echo "*    We removed the includes (compared to 1.7) for:"
echo "*        - cl/gc/InvoicePeriodDescriptionCode.gc"
echo "*    we renamed it and put it in:"
echo "*    cva/UBL-DefaultDTQ-2.0-NL-1.6.3.cva"
echo "* "
echo "* 5. We created the UBL_1_6_3_namespace_constraints.sch"
...
echo "*    UBL-DefaultDTQ-2-0-NL-1.6.3.cva"
echo "* "
echo "* 6. Be ware ! The UBL_1_6_3_namespace_constraints.sch does not contain"
echo "*    much, but it DOES INCLUDE the generated schematron from the "
echo "*    UBL-DefaultDTQ-2.0-NL-1.6.3.cva that contains ALL validations !"
echo "*    Thus, if you change this script for some new xsl-generation"
echo "*    make sure you also update the import statement in UBL_1_6_3_namespace_constraints.sch"
echo "* "
...
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh UBL-DefaultDTQ-2.0-NL-1.6.3.cva ../Crane-cva2sch-20120423-1830z/utility/Crane-cva2schXSLT.xsl output/UBL-DefaultDTQ-2.0-NL-1.6.3.sch.xsl

# step 2, exercise schematron xsl generator over itself, creating schematron output
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh output/UBL-DefaultDTQ-2.0-NL-1.6.3.sch.xsl output/UBL-DefaultDTQ-2.0-NL-1.6.3.sch.xsl output/UBL-DefaultDTQ-2.0-NL-1.6.3.sch

# step 3, Transform UBL_1_6_3_namespace_constraints (which INCLUDES the above output file UBL-DefaultDTQ-2.0-NL-1.6.3.sch !) into the final schematron file 
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh UBL_1_6_3_namespace_constraints.sch ../Crane-cva2sch-20120423-1830z/utility/iso_schematron_assembly.xsl output/Invoice-Genericode.sch
...
cp output/Invoice-Genericode.xsl ../../../src/main/resources/nl/clockwork/efactuur/nl/domain//ubl/1.6.3/.
