...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="ISO19757-3">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ApplicationResponse_SenderParty</xsl:attribute>
            <xsl:attribute name="name">ApplicationResponse_SenderParty</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ApplicationResponse_SenderParty_PartyIdentification</xsl:attribute>
            <xsl:attribute name="name">ApplicationResponse_SenderParty_PartyIdentification</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ApplicationResponse_ReceiverParty</xsl:attribute>
            <xsl:attribute name="name">ApplicationResponse_ReceiverParty</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ApplicationResponse_ReceiverParty_PartyIdentification</xsl:attribute>
            <xsl:attribute name="name">ApplicationResponse_ReceiverParty_PartyIdentification</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">ApplicationResponse_DocumentResponse_Response</xsl:attribute>
            <xsl:attribute name="name">ApplicationResponse_DocumentResponse_Response</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(cbc:UBLVersionID)">
               ...
               <svrl:text>/doc:ApplicationResponse/cbc:UBLVersionID element should exist!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(cbc:CustomizationID)">
               ...
               <svrl:text>/doc:ApplicationResponse/cbc:CustomizationID element should exist!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(cbc:ProfileID)">
               ...
               <svrl:text>/doc:ApplicationResponse/cbc:ProfileID element should exist!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cbc:UBLVersionID" priority="1003" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/doc:ApplicationResponse/cbc:UBLVersionID"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cbc:CustomizationID" priority="1002" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/doc:ApplicationResponse/cbc:CustomizationID"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cbc:ProfileID" priority="1001" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/doc:ApplicationResponse/cbc:ProfileID"/>
...
<xsl:choose>
   ...
   <!--PATTERN ApplicationResponse_SenderParty-->


	<!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cac:SenderParty" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>/doc:ApplicationResponse/cac:SenderParty/cac:PartyIdentification element should exist!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>/doc:ApplicationResponse/cac:SenderParty/cac:PartyIdentification element should be less than 3!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN ApplicationResponse_SenderParty-->
	...
	<!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cac:SenderParty" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/doc:ApplicationResponse/cac:SenderParty"/>
   ...
   <!--PATTERN ApplicationResponse_SenderParty-->
	...
	<!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cac:SenderParty" priority="1000" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/doc:ApplicationResponse/cac:SenderParty"/>
   ...
   <!--PATTERN ApplicationResponse_SenderParty_PartyIdentification-->
...
<xsl:choose>
   ...
   <!--PATTERN ApplicationResponse_ReceiverParty-->


	<!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cac:ReceiverParty" priority="1000" mode="M10">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>/doc:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification element should exist!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>/doc:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification element should be less than 3!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(cac:PartyName) lt 2">
               ...
               <svrl:text>/doc:ApplicationResponse/cac:ReceiverParty/cac:PartyName element should be less than 2!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN ApplicationResponse_ReceiverParty-->
	...
	<!--RULE -->
<xsl:template match="/doc:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification"
                 priority="1000"
                 mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/doc:ApplicationResponse/cac:ReceiverParty/cac:PartyIdentification"/>
   ...
   <!--PATTERN ApplicationResponse_ReceiverParty_PartyIdentification-->
...
<xsl:choose>
   ...
   <!--PATTERN ApplicationResponse_DocumentResponse_Response-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(cbc:Description) lt 2">
               ...
               <svrl:text>/doc:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:Description element should be less than 2!</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
