...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Validations for ApplicationResponse Mapping"
                              schemaVersion="">
         <xsl:comment>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Validations for ApplicationResponse Mapping</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN type-restrictions-->
	...
	<!--RULE -->
<xsl:template match="doc:ApplicationResponse" priority="1003" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="doc:ApplicationResponse"/>
