clear
echo "*********************************************************************************************************"
echo "* Transforming UBL 1.6.2 Genericode Schematron into XSLT "
echo "* - - - - - - - - - - - - - - - - - - - - - - - - - - - - "
...
echo "*    cva/UBL-DefaultDTQ-2.0-NL-1.6.2.cva"
echo "* "
echo "* 5. We created the UBL_1_6_2_namespace_constraints.sch"
...
echo "*    UBL-DefaultDTQ-2-0-NL-1.6.2.cva"
echo "* "
echo "* 6. Be ware ! The UBL_1_6_2_namespace_constraints.sch does not contain"
echo "*    much, but it DOES INCLUDE the generated schematron from the "
echo "*    UBL-DefaultDTQ-2.0-NL-1.6.2.cva that contains ALL validations !"
echo "*    Thus, if you change this script for some new xsl-generation"
echo "*    make sure you also update the import statement in UBL_1_6_2_namespace_constraints.sch"
echo "* "
...
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh UBL-DefaultDTQ-2.0-NL-1.6.2.cva ../Crane-cva2sch-20120423-1830z/utility/Crane-cva2schXSLT.xsl output/UBL-DefaultDTQ-2.0-NL-1.6.2.sch.xsl

# step 2, exercise schematron xsl generator over itself, creating schematron output
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh output/UBL-DefaultDTQ-2.0-NL-1.6.2.sch.xsl output/UBL-DefaultDTQ-2.0-NL-1.6.2.sch.xsl output/UBL-DefaultDTQ-2.0-NL-1.6.2.sch

# step 3, Transform UBL_1_6_2_namespace_constraints (which INCLUDES the above output file UBL-DefaultDTQ-2.0-NL-1.6.2.sch !) into the final schematron file 
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh UBL_1_6_2_namespace_constraints.sch ../Crane-cva2sch-20120423-1830z/utility/iso_schematron_assembly.xsl output/Invoice-Genericode.sch
