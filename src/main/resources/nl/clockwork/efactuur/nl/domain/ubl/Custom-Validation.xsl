...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">SI-UBL-VERSION</xsl:attribute>
            <xsl:attribute name="name">SI-UBL-VERSION</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--PATTERN SI-UBL-VERSION-->
	  ...
	  <!--RULE -->
   <xsl:template match="ubl:Invoice/cac:InvoiceLine/cac:AllowanceCharge"
                 priority="9999"
                 mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(cbc:ChargeIndicator='false' and starts-with(cbc:Amount,'-'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not(cbc:ChargeIndicator='false' and starts-with(cbc:Amount,'-'))">
               <xsl:attribute name="id">UBL-CUSTOM-01</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>[UBL-CUSTOM-01]-ChargeIndicator and Amount are ambiguous. ChargeIndicator='false' and Amount starts with '-'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
