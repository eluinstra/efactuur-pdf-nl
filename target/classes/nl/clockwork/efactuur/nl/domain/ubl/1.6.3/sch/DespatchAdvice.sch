...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  <title>Validations for DespatchAdvice Mapping</title>
  ...
  <pattern id="cardinality-redefines">
    ...
    <rule context="doc:DespatchAdvice/cac:SellerSupplierParty/cac:Party">
      ...
      <assert test="count(cac:PartyIdentification) &gt;= 1 and count(cac:PartyIdentification) &lt;= 2">doc:DespatchAdvice/cac:SellerSupplierParty/cac:Party must contain cac:PartyIdentification at least 1 and at most 2 time(s)</assert>
