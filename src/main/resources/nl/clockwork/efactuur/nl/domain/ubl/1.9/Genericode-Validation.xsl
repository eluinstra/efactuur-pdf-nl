...
<!--PATTERN UBL-QualifiedDataTypes-2.0-->
   ...
   <axsl:template match="cbc:ActionCode" priority="1004" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="( false() or ( ( not(@listName!='ActieCode') ) and ( not(@listID!='NL-1006') ) and ( not(@listVersionID!='1.9') ) and ( not(@listSchemeURI!='urn:digi-inkoop:ubl:2.0:NL:1.9:gc:ActionCode') ) and ( not(@listURI!='http://www.nltaxonomie.nl/ubl/2.0/NL/1.9/cl/gc/NL-ActionCode-1.9.gc') ) and ( not(@listAgencyName!='Logius Gegevensbeheer NL-Overheid') ) and ( not(@listAgencyID!='88') ) and contains('RV',concat('',.,'')) ) ) "/>
         <axsl:otherwise>Value supplied '<axsl:text/>
            <axsl:value-of select="."/>
   ...
   <axsl:template match="cac:DeliveryTerms/cbc:ID" priority="1003" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="( false() or ( ( not(@listName!='Leveringsvoorwaarden') ) and ( not(@schemeID!='NL-1002') ) and ( not(@listVersionID!='1.8') ) and ( not(@listSchemeURI!='urn:digi-inkoop:ubl:2.0:NL:1.8:gc:DeliveryTermsCode') ) and ( not(@listURI!='http://www.nltaxonomie.nl/ubl/2.0/NL/1.8/cl/gc/DeliveryTermsCode.gc') ) and ( not(@listAgencyName!='Logius Gegevensbeheer NL-Overheid') ) and ( not(@listAgencyID!='88') ) and contains('EXWFCAFASFOBFOTFOPFORCFRCIFCPTCIPDAFDESDEQDDUDDPDATDAP',concat('',.,'')) ) ) "/>
         <axsl:otherwise>Value supplied '<axsl:text/>
            <axsl:value-of select="."/>
   ...
   <axsl:template match="cac:Response/cbc:ResponseCode" priority="1000" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="( false() or ( ( not(@listName!='ResponseCode') ) and ( not(@listID!='NL-1005') ) and ( not(@listVersionID!='1.9') ) and ( not(@listSchemeURI!='urn:digi-inkoop:ubl:2.0:NL:1.9:gc:ResponseCode') ) and ( not(@listURI!='http://www.nltaxonomie.nl/ubl/2.0/NL/1.9/cl/gc/NL-ResponseCode-1.9.gc') ) and ( not(@listAgencyName!='Logius Gegevensbeheer NL-Overheid') ) and ( not(@listAgencyID!='88') ) and contains('OKNOK',concat('',.,'')) ) ) "/>
         <axsl:otherwise>Value supplied '<axsl:text/>
            <axsl:value-of select="."/>
