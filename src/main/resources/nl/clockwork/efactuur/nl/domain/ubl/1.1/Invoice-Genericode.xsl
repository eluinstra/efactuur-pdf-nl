...
<!--PATTERN UBL-QualifiedDataTypes-2.0-->
   ...
   <axsl:template match="cbc:AllowanceChargeReasonCode" priority="1014" mode="M4">
...
<!--       <axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/> -->
   ...
   <axsl:template match="cbc:ChannelCode" priority="1013" mode="M4">
   ...
   <axsl:template match="cbc:CardChipCode" priority="1012" mode="M4">
   ...
   <axsl:template match="cbc:IdentificationCode" priority="1011" mode="M4">
   ...
   <axsl:template match="cbc:DocumentCurrencyCode |                          cbc:TaxCurrencyCode |                          cbc:PricingCurrencyCode |                          cbc:PaymentCurrencyCode |                          cbc:PaymentAlternativeCurrencyCode |                          cbc:RequestedInvoiceCurrencyCode |                          cbc:SourceCurrencyCode |                          cbc:TargetCurrencyCode |                          cbc:CurrencyCode" priority="1010" mode="M4">
   ...
   <axsl:template match="cbc:LatitudeDirectionCode" priority="1009" mode="M4">
   ...
   <axsl:template match="cbc:LineStatusCode" priority="1008" mode="M4">
   ...
   <axsl:template match="cbc:LongitudeDirectionCode" priority="1007" mode="M4">
   ...
   <axsl:template match="cbc:MathematicOperatorCode" priority="1006" mode="M4">
   ...
   <axsl:template match="cbc:PackagingTypeCode" priority="1005" mode="M4">
   ...
   <axsl:template match="cbc:PaymentMeansCode" priority="1004" mode="M4">
   ...
   <axsl:template match="cbc:SubstitutionStatusCode" priority="1003" mode="M4">
   ...
   <axsl:template match="cbc:TransportEquipmentTypeCode" priority="1002" mode="M4">
   ...
   <axsl:template match="cbc:TransportModeCode" priority="1001" mode="M4">
   ...
   <axsl:template match="cbc:InvoiceTypeCode" priority="1000" mode="M4">

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="( false() or ( ( not(@listName!='FactuurSoort') ) and ( not(@listID!='NL-1001') ) and ( not(@listVersionID!='0.1') ) and ( not(@listSchemeURI!='http://www.nltaxonomie.nl/ubl/2.0/NL/1.0/cl/gc/NL-InvoiceCode') ) and ( not(@listURI!='http://www.nltaxonomie.nl/ubl/2.0/NL/1.0/cl/gc/NL-InvoiceCode-1.0.gc') ) and ( not(@listAgencyName!='Logius Gegevensbeheer NL-Overheid') ) and ( not(@listAgencyID!='88') ) and contains('123',concat('',.,'')) ) ) "/>
         <axsl:otherwise>Value supplied '<axsl:text/>
            <axsl:value-of select="."/>
