...
<xsl:stylesheet xmlns:xhtml="http://www.w3.org/1999/xhtml"
                ...
                xmlns:doc="urn:digi-inkoop:ubl:2.0:NL:1.7:UBL-NL-Commitment-2"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:digi-inkoop:ubl:2.0:NL:1.7:UBL-NL-CommonAggregateComponents-2"
                                             prefix="nl-cac"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:digi-inkoop:ubl:2.0:NL:1.7:UBL-NL-Commitment-2" prefix="doc"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="doc:Commitment/cac:DocumentReference/cac:Attachment" priority="1007"
                 mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
