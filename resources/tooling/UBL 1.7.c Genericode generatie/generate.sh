clear
echo "*********************************************************************************************************"
echo "* Transforming UBL 1.7 Genericode Schematron into XSLT "
echo "* - - - - - - - - - - - - - - - - - - - - - - - - - - - - "
...
echo "*    cva/UBL-DefaultDTQ-2.0-NL-1.7.cva"
echo "* "
...
echo "*    UBL-DefaultDTQ-2-0-NL-1.7.cva"
echo "* "
...
echo "*    UBL-DefaultDTQ-2.0-NL-1.7.cva that contains ALL validations !"
...
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh UBL-DefaultDTQ-2.0-NL-1.7.cva ../Crane-cva2sch-20120423-1830z/utility/Crane-cva2schXSLT.xsl output/UBL-DefaultDTQ-2.0-NL-1.7.sch.xsl

# step 2, exercise schematron xsl generator over itself, creating schematron output
sh ../Crane-cva2sch-20120423-1830z/utility/xslt.sh output/UBL-DefaultDTQ-2.0-NL-1.7.sch.xsl output/UBL-DefaultDTQ-2.0-NL-1.7.sch.xsl output/UBL-DefaultDTQ-2.0-NL-1.7.sch

# step 3, Transform UBL_1_7_namespace_constraints (which INCLUDES the above output file UBL-DefaultDTQ-2.0-NL-1.7.sch !) into the final schematron file 
...
cp output/Invoice-Genericode.xsl ../../../src/main/resources/nl/clockwork/efactuur/nl/domain/ubl/1.7.c/.
